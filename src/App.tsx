      ...
      {showSettings ? (
        ...
        <main className="flex-1 min-h-0 overflow-y-auto flex items-center justify-center px-8 pb-12 pt-4">
          <div className="flex flex-col lg:flex-row gap-6 w-full max-w-6xl">
            ...
            {/* Left — Timer */}
            <div className="lg:w-[460px] lg:shrink-0 bg-white/[0.05] rounded-3xl overflow-hidden shadow-[3px_4px_14px_rgba(30,60,120,0.35)]">
            ...
            {/* Right — Tasks */}
            <div className="flex-1 bg-white/[0.05] rounded-3xl overflow-hidden shadow-[3px_4px_14px_rgba(30,60,120,0.35)]">
